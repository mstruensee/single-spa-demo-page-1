...
const url = `https://wcs-single-spa-demo.s3.amazonaws.com/%40wcs/page-1/${process.env.TRAVIS_COMMIT}/wcs-single-spa-demo-page-1.js`;
  ...
  .get(url, (res) => {
    ...
    if (res.statusCode >= 200 && res.statusCode < 300) {
      if (
        ...
        const moduleName = "@wcs/single-spa-demo-page-1";
